...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\Bilkheyr\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\Bilkheyr\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'generated::C5AxOKThJrKMi5pI','generated::zqQXEAicI6CdIJgw','dashboard','profile.edit','profile.update',
'profile.destroy','lock-screen','unlock','profile-user','company-structure',
'company-settings','company.update','branch.store','branch.update','branch.delete',
'store.store','store.update','store.delete','capital-deposit','capital-deposit.store',
'shareholder.store','shareholder.update','shareholder.delete','employee.index','employee.assign-login',
'employee.update-login','employee.create','employee.store','employee.update','employee.destroy',
'role.index','role.store','role.update','role.destroy','backup-restore',
'backup.create','backup.download','backup.delete','backup.restore','backup.gmail',
'account.index','account.export','account.download-template','account.import','account.ledger',
'account.trial-balance','local_bank_account.index','cash_management.index','account_management.index','bank.transaction.deposit',
'bank.transaction.withdraw','bank.transaction.transfer','bank.transaction.adjustment','account.store','account.update',
'account.destroy','journal.index','journal.store','journal.destroy','customer.index',
'customer.export','customer.statement','download.statement.customer','email.statement.customer','customer.store',
'customer.import','customer.update','customer.destroy','supplier.index','supplier.statement',
'download.statement.supplier','email.statement.supplier','supplier.store','supplier.update','supplier.destroy',
'product.index','product.export','product.download-template','product.import','product.store',
'product.update','product.delete','product.update-status','product.quick.store','low-stock.view',
'store-summary.view','stock-adjustment.view','stock-adjustment.store','category.index','category.store',
'category.update','category.delete','purchase.order.index','purchase.order.create','purchase.order.store',
'purchase.order.show','purchase.bill.create','purchase.bill.store','purchase.bill.export','purchase.bill.show',
'purchase.bill','purchase.view','purchase.expense','purchase.expense.store','purchase.returns',
'purchase.return.store','purchase.return.delete','purchase.return.view','purchase.return.pdf','view_payment_out',
'payment_out.store','payment_out.view','payment_out.download','payment_out.delete','payment_out.update-status',
'sales.invoice.view','sales.invoice.create','sales.invoice.store','sales.invoice.show','sales.invoice.edit',
'sales.invoice.update','sales.invoice.delete','sales.invoice.pdf','sales.invoice.update-status','sales.pos.view',
'sales.quick.customer','view_payment_in','payment_in.store','payment_in.view','payment_in.download',
'payment_in.delete','payment_in.update-status','branches-view','stores-view','store-management',
'store-transfer','branch_store_transfer','branch-transfer','store-transfer.store','store-transfer.check-stock',
'store-transfer.action','expenses_view_all','expenses.store','expenses.edit','expenses.update',
'expenses.delete','expenses.receipt','all_reports','reports.sales','reports.sales.pdf',
'reports.sales.excel','reports.purchases','reports.purchases.pdf','reports.purchases.excel','reports.daybook',
'reports.daybook.pdf','reports.daybook.excel','reports.transaction','reports.transaction.pdf','reports.transaction.excel',
'reports.profit_loss','reports.profit_loss.pdf','reports.bill_wise_profit','reports.bill_wise_profit.pdf','reports.trial_balance',
'reports.trial_balance.pdf','reports.balance_sheet','reports.balance_sheet.pdf','reports.cash_flow','reports.cash_flow.pdf',
'reports.party_statement','reports.party_statement.pdf','reports.party_wise_profit_loss','reports.party_wise_profit_loss.pdf','reports.party_all',
'reports.party_all.pdf','reports.sales_purchase_by_party','reports.sales_purchase_by_party.pdf','reports.sales_purchase_by_party_group','reports.sales_purchase_by_party_group.pdf',
'reports.summary_stock','reports.summary_stock.pdf','reports.low_stock_summary','reports.low_stock_summary.pdf','reports.item_report_by_party',
'reports.item_report_by_party.pdf','reports.item_wise_profit_loss','reports.item_wise_profit_loss.pdf','reports.item_category_wise_profit_loss','reports.item_category_wise_profit_loss.pdf',
'reports.stock_details','reports.stock_details.pdf','reports.items_details','reports.items_details.pdf','reports.sale_purchase_by_item_category',
'reports.sale_purchase_by_item_category.pdf','audit-logs','subscribers.plans.index','subscribers.plans.store','subscribers.plans.update',
'subscribers.plans.delete','subscribers.subscriptions.index','subscribers_pricing','register','generated::JdMajEkZMH2tGE14',
'login','generated::eDSCCDTRE0OQvMQ4','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::0OUhQSICd8tgBh1l','password.update','logout','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.admin_master','admin.body.header','admin.body.sidebar','admin.index','admin.subscribers.plans.index',
'admin.subscribers.subscriptions.index','auth.confirm-password','auth.forgot-password','auth.lock-screen','auth.login',
'auth.logout','auth.register','auth.reset-password','auth.verify-email','components.application-logo',
...
'components.input-label','components.kpi-card','components.modal','components.nav-link','components.primary-button',
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','emails.backup',
'frontend.account.account_management','frontend.account.cash_management','frontend.account.chart_accounts','frontend.account.journal_entry','frontend.account.ledger',
'frontend.account.trial_balance','frontend.branch.branch_store_transfer','frontend.branch.branch_transfer','frontend.branch.branches','frontend.branch.cash_management',
'frontend.branch.store_management','frontend.branch.store_transfer','frontend.branch.stores','frontend.expense.add_all_expenses','frontend.expense.pdf_expense_receipt',
'frontend.parties.customer','frontend.parties.customer_statement','frontend.parties.pdf_customer_statement','frontend.parties.pdf_supplier_statement','frontend.parties.supplier',
'frontend.parties.supplier_statement','frontend.product.Low_alerts','frontend.product.add_product','frontend.product.category','frontend.product.stock_adjustment',
'frontend.product.stock_summary','frontend.purchase.add_purchase_bill','frontend.purchase.pdf_payment_voucher','frontend.purchase.pdf_purchase_return','frontend.purchase.purchase_bill',
'frontend.purchase.purchase_expenses','frontend.purchase.purchase_order','frontend.purchase.purchase_return','frontend.purchase.supplier_payment','frontend.purchase.view_purchase_return',
'frontend.report.Balance_sheet_reports','frontend.report.Item_category_wise_profit_loss_pdf_reports','frontend.report.Item_category_wise_profit_loss_reports','frontend.report.Item_details_pdf_reports','frontend.report.Item_details_reports',
'frontend.report.Item_report_by_party','frontend.report.Item_report_by_party_pdf_reports','frontend.report.Item_wise_profit_Loss_pdf_reports','frontend.report.Item_wise_profit_Loss_report','frontend.report.Low_stock_summary_pdf_reports',
'frontend.report.Low_stock_summary_reports','frontend.report.Parties_Statement_reports','frontend.report.Parties_Statement_reports_bak','frontend.report.Parties_statement_pdf_reports','frontend.report.all_parties_pdf_reports',
'frontend.report.all_parties_reports','frontend.report.all_reports','frontend.report.balance_sheet_pdf_reports','frontend.report.bill_wise_profit_pdf_reports','frontend.report.bill_wise_profit_reports',
'frontend.report.cash_flow_pdf_reports','frontend.report.cash_flow_reports','frontend.report.daybook_reports','frontend.report.daybook_reports_pdf','frontend.report.party_wise_profit_Loss_pdf_reports',
'frontend.report.party_wise_profit_Loss_reports','frontend.report.profit_loss_reports','frontend.report.profit_loss_reports_pdf','frontend.report.purchase_reports','frontend.report.purchase_reports_pdf',
'frontend.report.sale_purchase_by_party_group_pdf','frontend.report.sale_purchase_by_party_group_reports','frontend.report.sale_purchase_item_category_pdf_reports','frontend.report.sale_purchase_item_category_reports','frontend.report.sale_reports',
'frontend.report.sale_reports_pdf','frontend.report.sales_purchase_by_party_pdf_reports','frontend.report.sales_purchase_by_party_reports','frontend.report.stock_details_pdf_reports','frontend.report.stock_details_reports',
'frontend.report.summary_stock_pdf_reports','frontend.report.summary_stock_reports','frontend.report.transaction_reports','frontend.report.transaction_reports_pdf','frontend.report.trial_balance_pdf_reports',
'frontend.report.trial_balance_reports','frontend.sales.add_invoice_sales','frontend.sales.payment_in','frontend.sales.pdf_receipt','frontend.sales.sales_edit',
'frontend.sales.sales_invoice','frontend.sales.sales_invoice_pdf','frontend.sales.sales_pos','frontend.setting.Assign_login','frontend.setting.audit_logs',
'frontend.setting.backup_restore','frontend.setting.capital_deposit','frontend.setting.company_setting','frontend.setting.company_structure','frontend.setting.employee',
'frontend.setting.role','frontend.subscribers.plans_pricing','layouts.app','layouts.guest','layouts.navigation',
'pagination::custom','partials.logo_svg','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','vendor.pagination.custom','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.Bilkheyr.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_VERIFY_PEER','MAIL_VERIFY_PEER_NAME',
