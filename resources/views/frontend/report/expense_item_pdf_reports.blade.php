...
<head>
    <meta charset="UTF-8">
    <title>Expense Item Report — {{ $company->name ?? 'Company' }}</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div>
            ...
            <div style="float: left;">
                ...
                <div class="report-title">Expense Item Report</div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="bold">{{ $row->expense_name }}</td>
                <td class="right">{{ number_format($row->avg_amount, 2) }}</td>
    ...
    <div class="footer">
        {{ $company->name ?? 'Company' }} — Expense Item Analysis — Confidential
    </div>
