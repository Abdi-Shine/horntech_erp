...
namespace Illuminate\Support\Facades {
    ...
    class Schema {
         ...
         *
         * @param string $table
         * @param \Closure|array|string|\Illuminate\Contracts\Database\Query\Expression $columns
         * @return bool
         * @static
         */
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         * @static
         */
        public static function where(\Closure|array|string $column, $operator = null, $value = null, $boolean = 'and')
        {
            /** @var \Illuminate\Database\Eloquent\Builder $instance */
